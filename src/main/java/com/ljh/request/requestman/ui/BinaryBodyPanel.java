...
//    private final JScrollPane scrollPane;
    ...
    public BinaryBodyPanel(List<ApiParam> bodyParamList) {
        ...
        filePathField.setToolTipText(RequestManBundle.message("binary.selected.file.path"));

        selectFileButton = new JButton(RequestManBundle.message("binary.select.file"));
        clearButton = new JButton(RequestManBundle.message("binary.clear"));
...
//        scrollPane.setPreferredSize(new Dimension(600, 120));
        ...
        labelPanel.add(new JLabel(RequestManBundle.message("binary.file.selection") + ":"), BorderLayout.WEST);
...
//        add(scrollPane, BorderLayout.SOUTH);
        ...
        if (bodyParamList != null && !bodyParamList.isEmpty()) {
            ...
            if (hasFile) {
                filePathField.setText(RequestManBundle.message("binary.file.type.detected"));
            }
        }
    }
    ...
    private void selectFile() {
        ...
        fileChooser.setDialogTitle(RequestManBundle.message("binary.select.binary.file"));
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            filePathField.setToolTipText(RequestManBundle.message("binary.file.size") + ": " + sizeText);
        }
    }
...
//    }
    ...
    public void setFilePathFromBinaryText(String binaryText) {
        if (filePathField != null && StringUtils.isNotBlank(binaryText)) {
            File file = new File(binaryText);
            if (!file.exists()) {
                return;
            }
            selectedFile = file;
